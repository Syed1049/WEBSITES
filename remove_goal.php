...
$sql = "SELECT goal_name,target_amount  FROM savings_goals";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<tr><td>" . $row["goal_name"]. "</td><td>" . $row["target_amount"]. "</td></tr>";

              echo "<td><form action='deletegoal.php' method='post'><input type='hidden' name='firstn' value='$name' /><input type='submit' value='Delete' /></form></td></tr>";
